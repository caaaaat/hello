        ...
        fillHtml:function(obj,args){
            return (function(){
                ...
                if(args.current > 1){
                    ...
                    obj.remove('.previous');
                    obj.append('<button class="btn btn-white disabled" type="button"><i class="fa fa-chevron-left"></i></button>');
                }
                ...
                if(args.current < args.pageCount){
                    obj.append('<button class="btn btn-white next" type="button"><i class="fa fa-chevron-right"></i></button>');
                }else{
                    obj.remove('.next');
                    obj.append('<button class="btn btn-white disabled" type="button"><i class="fa fa-chevron-right"></i></button>');
                }
            })();
        },
        //绑定事件
