var areaMap = [
    {
        ...
        "city": [
            ...
            {"name": "延边", "area": ["延吉市", "图们市", "敦化市", "龙井市", "珲春市", "和龙市", "安图县", "汪清县", "其他"]},
            {"name": "其他", "area": ["其他"]}
        ]
    }, {
        "name": "黑龙江",
        "city": [
            ...
            {"name": "大兴安岭", "area": ["呼玛县", "塔河县", "漠河县", "大兴安岭辖区", "其他"]},
            {"name": "其他", "area": ["其他"]}
        ]
    }, {
        "name": "江苏",
        ...
        "city": [
            ...
            {"name": "日照", "area": ["东港区", "岚山区", "五莲县", "莒县", "其他"]}, {"name": "莱芜", "area": ["莱城区", "钢城区", "其他"]},
        ...
        "city": [
            ...
            {"name": "许昌", "area": ["魏都区", "禹州市", "长葛市", "许昌县", "鄢陵县", "襄城县", "其他"]}, {"name": "漯河", "area": ["源汇区", "郾城区", "召陵区", "临颍县", "舞阳县", "其他"]},
        ...
        "city": [
            ...
            {"name": "阿坝", "area": ["马尔康县", "九寨沟县", "红原县", "汶川县", "阿坝县", "理县", "若尔盖县", "小金县", "黑水县", "金川县", "松潘县", "壤塘县", "茂县", "其他"]},
        ...
        "city": [
            ...
            {"name": "那曲", "area": ["那曲县", "嘉黎县", "比如县", "聂荣县", "安多县", "申扎县", "索县", "班戈县", "巴青县", "尼玛县", "其他"]},
            {"name": "昌都", "area": ["昌都县", "江达县", "贡觉县", "类乌齐县", "丁青县", "察雅县", "八宿县", "左贡县", "芒康县", "洛隆县", "边坝县", "其他"]},
            {"name": "林芝", "area": ["林芝县", "工布江达县", "米林县", "墨脱县", "波密县", "察隅县", "朗县", "其他"]},
            {"name": "山南", "area": ["乃东县", "扎囊县", "贡嘎县", "桑日县", "琼结县", "曲松县", "措美县", "洛扎县", "加查县", "隆子县", "错那县", "浪卡子县", "其他"]},
            {"name": "日喀则", "area": ["日喀则市", "南木林县", "江孜县", "定日县", "萨迦县", "拉孜县", "昂仁县", "谢通门县", "白朗县", "仁布县", "康马县", "定结县", "仲巴县", "亚东县", "吉隆县", "聂拉木县", "萨嘎县", "岗巴县", "其他"]},
            {"name": "阿里", "area": ["噶尔县", "普兰县", "札达县", "日土县", "革吉县", "改则县", "措勤县", "其他"]},
            {"name": "其他", "area": ["其他"]}
        ]
    },{
        "name": "宁夏",
        ...
        "city": [
            ...
            {"name": "吐鲁番", "area": ["吐鲁番市", "托克逊县", "鄯善县", "其他"]},
            {"name": "哈密", "area": ["哈密市", "伊吾县", "巴里坤哈萨克自治县", "其他"]},
            {"name": "和田", "area": ["和田市", "和田县", "洛浦县", "民丰县", "皮山县", "策勒县", "于田县", "墨玉县", "其他"]},
            {"name": "阿克苏", "area": ["阿克苏市", "温宿县", "沙雅县", "拜城县", "阿瓦提县", "库车县", "柯坪县", "新和县", "乌什县", "其他"]},
            {"name": "喀什", "area": ["喀什市", "巴楚县", "泽普县", "伽师县", "叶城县", "岳普湖县", "疏勒县", "麦盖提县", "英吉沙县", "莎车县", "疏附县", "塔什库尔干塔吉克自治县", "其他"]},
            {"name": "克孜勒苏柯尔克孜", "area": ["阿图什市", "阿合奇县", "乌恰县", "阿克陶县", "其他"]},
            {"name": "巴音郭楞", "area": ["库尔勒市", "和静县", "尉犁县", "和硕县", "且末县", "博湖县", "轮台县", "若羌县", "焉耆回族自治县", "其他"]},
            {"name": "昌吉", "area": ["昌吉市", "阜康市", "奇台县", "玛纳斯县", "吉木萨尔县", "呼图壁县", "木垒哈萨克自治县", "米泉市", "其他"]},
            {"name": "博尔塔拉", "area": ["博乐市", "精河县", "温泉县", "其他"]},
            {"name": "石河子", "area": ["石河子"]},
            {"name": "阿拉尔", "area": ["阿拉尔"]},
            {"name": "图木舒克", "area": ["图木舒克"]},
            {"name": "五家渠", "area": ["五家渠"]},
            {"name": "伊犁哈萨克", "area": ["伊宁市", "奎屯市", "伊宁县", "特克斯县", "尼勒克县", "昭苏县", "新源县", "霍城县", "巩留县", "察布查尔锡伯自治县", "塔城地区", "阿勒泰地区", "其他"]},
            {"name": "其他", "area": ["其他"]}
        ]
    }, {
        "name": "澳门",
...
//设置
function setProvince(Province,def,City,Country){
    var provinceStr = "";
    provinceStr += "<option value>全部</option>";
    for(var i= 0; i < areaMap.length; i++){
        if(areaMap[i]['name'] == def){
            provinceStr += "<option value='"+areaMap[i]['name']+"' selected>"+areaMap[i]['name']+"</option>" ;
        }else {
            provinceStr += "<option value='"+areaMap[i]['name']+"'>"+areaMap[i]['name']+"</option>" ;
        }
    }
     // jQuery(Province).html(provinceStr);
    document.getElementById(Province).innerHTML = provinceStr ;
    setCity(document.getElementById(Province).value,City,Country)
}
//城市联动
function setCity(ProvinceVal,City,Country){
    if( ProvinceVal == 0 || ProvinceVal == '全部' || ProvinceVal == '' ){
        document.getElementById(City).innerHTML = '<option>全部</option>' ;
        document.getElementById(Country).innerHTML = '<option>全部</option>' ;
    }else{
        for(key in areaMap){
            //console.log(areaMap[key]['name']);
            if(areaMap[key].name == ProvinceVal){
                var cityStr = '';
                cityStr += '<option>全部</option>';
                var cityItem    = areaMap[key].city;
                var cityItemLen = areaMap[key].city.length;
                //+-------city start-------------
                for(var i= 0;i < cityItemLen;i++){
                    var temp = cityItem[i];
                    //console.log(temp);
                    if(document.getElementById(City).value == temp['name']){
                        cityStr += '<option value="'+temp.name+'" selected>'+temp.name+'</option>';
                    }else{
                        cityStr += '<option value="'+temp.name+'">'+temp.name+'</option>';
                    }
                }
                //console.log(cityStr) ;
    ...
    //搜索栏市区域变化
    setCounty(ProvinceVal,document.getElementById(City).value,Country);
}
//区县联动
function setCounty(ProvinceVal,CityVal,county){
    if(ProvinceVal == 0  || CityVal == 0 || CityVal == '全部' || CityVal == ''){
        document.getElementById(county).innerHTML = '<option>全部</option>';
    }else{
        for(key in areaMap){
            //console.log(p_val);
            if(areaMap[key].name == ProvinceVal){
                ...
                for(var i= 0;i < cityItemLen;i++){
                    var temp = cityItem[i];
                    if(CityVal == temp.name){
                        var countyStr ='';
                        countyStr +='<option>全部</option>';
                        var countyItem = temp['area'];
                        var countyItemLen = temp['area'].length;
                        for(var j = 0; j < countyItemLen; j++){

                            if(document.getElementById(county).value == countyItem[j]){
                                countyStr += '<option value="'+countyItem[j]+'" selected>'+countyItem[j]+'</option>';
                            }else{
                                countyStr += '<option value="'+countyItem[j]+'">'+countyItem[j]+'</option>';
                            }
                        }
                    }
                }
                if(county){
                    document.getElementById(county).innerHTML = countyStr ;
                }
            }
        }
    }
